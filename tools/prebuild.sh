...
# note, this gets version 56.0.  To change versions requires changing the following line in two places
export srcjar=http://sagebionetworks.artifactoryonline.com/sagebionetworks/libs-releases-local/org/sagebionetworks/lib-auto-generated/56.0/lib-auto-generated-56.0.jar
