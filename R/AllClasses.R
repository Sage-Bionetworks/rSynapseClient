...
# This is the class that "auto-generated" classes from JSON schemas extend
# "extra" holds content that doesn't correspond to an S4 slot but nevertheless
# has to be carried along with the object (see SYNR-906)
setClass(
	Class="AutoGenerated",
	representation=representation(extra="list"), 
	prototype=list(extra=list())
)
